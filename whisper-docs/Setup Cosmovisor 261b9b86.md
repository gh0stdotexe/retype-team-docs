...
```shell
mkdir -p ~/.cheqdnode/cosmovisor/genesis/bin 
mkdir -p ~/.cheqdnode/cosmovisor/upgrades
...
```shell
cp $GOPATH/bin/cheqd-noded ~/.cheqdnode/cosmovisor/genesis/bin
```
...
Environment="DAEMON_HOME=/home/whispernode/.cheqdnode"
