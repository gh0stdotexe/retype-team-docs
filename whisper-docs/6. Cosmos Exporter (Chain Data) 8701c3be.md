Grafana template link: (import # `14914 )`\
[Cosmos Validator dashboard for Grafana](https://grafana.com/grafana/dashboards/14914 "Cosmos Validator dashboard for Grafana")
...
![dashboard\_validator.png](files/1e11708a-815d-4cfc-826d-436ab62243d9/dashboard_validator.png)
![dashboard\_validators.png](files/dca48437-bd27-475f-baaa-ffa8e5d1e23a/dashboard_validators.png)
![dashboard\_wallet.png](files/4329e010-58df-4a97-bc99-f26d933e0ca3/dashboard_wallet.png)
...
```shell
sudo wget https://github.com/solarlabsteam/cosmos-exporter/releases/download/v0.2.1/cosmos-exporter_0.2.1_Linux_x86_64.tar.gz
tar xvfz cosmos-exporter_0.2.1_Linux_x86_64.tar.gz
sudo ./cosmos-exporter
```
...
- `--tendermint-rpc` - Tendermint RPC URL to query node stats (specifically `chain-id`). Defaults to [`http://localhost:26657`](http://localhost:26657)
