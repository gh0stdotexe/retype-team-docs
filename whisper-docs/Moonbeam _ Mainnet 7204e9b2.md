...
If you are connecting to Testnet instead (Moonbase Alpha), you will also need to change the path to `/home/whispernode/moonbeam-data/` and add `--chain moonbeam`.
