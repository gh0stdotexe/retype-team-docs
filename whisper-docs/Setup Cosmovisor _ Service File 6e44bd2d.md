...
sudo chown -R whispernode:whispernode ~/.source/cosmovisor
```
...
```shell
cp $GOPATH/bin/sourced ~/.source/cosmovisor/genesis/bin
```
...
Environment="DAEMON_HOME=/home/whispernode/.source"
...
[Service]
User=whispernode
ExecStart=/home/whispernode/go/bin/sourced start
Restart=always
RestartSec=3
LimitNOFILE=65535
Environment="DAEMON_NAME=sourced"
