...
```shell
# cosmovisor - Sentinelhub
export DAEMON_NAME=sentinelhub
export DAEMON_HOME=$HOME/.sentinelhub
```
...
Then use the path returned to copy it to the directory Cosmovisor expects. Let's assume the previous command returned `/home/your-user/go/bin/sentinelhub`:
...
Environment="DAEMON_HOME=/home/whispernode/.sentinelhub"
